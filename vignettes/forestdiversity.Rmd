...
Some notation explanation: TimeToRecover is the time to recovery, ThetaRecovery is the recovery rate computed after X years and DegreeRecovery is the degree of recovery after X years (the argument RecTime, here 20).
If TimeToRecovery and ThetaRecovery are -99, it means the system did not reach recovery.
