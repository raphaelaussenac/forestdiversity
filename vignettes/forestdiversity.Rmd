...
Three resilience metrics can be computed for a selected variable: Time to recover, Degree of recovery after X years (by default X=20 years) and the recovery rate.
