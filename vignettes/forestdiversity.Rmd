...
```
For Nk number of neighboors (here 4) we get mk the mingling index for k neighboors.
Em is the expected mingling index in case of independent species, and does not depend on the number of neighboors.
Phi is simply $1 - \frac{mk}{Em}$ : if phi is 0 then species in the plot are independantly organized, if phi is 1 then species seggregation is maximum, and if phi is -1 then attraction of different species is maximum.
