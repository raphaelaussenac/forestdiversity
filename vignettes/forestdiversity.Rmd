...
In the latter case the arguments ClassInter and ClassIni will define are DBH classes are built.
...
The function ComputeSh will then compute different heterogeneity indices from this gridded dataset, that is
